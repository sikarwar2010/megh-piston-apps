        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-primary">Global Automotive Industries</span>
            </motion.h1>
            <motion.p
              variants={fadeIn}
      ...
      <section className="py-12 sm:py-16 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Meghdoot Pistons Pvt. Ltd. global footprint includes more than 20
          ...
          <motion.div
            ...
            className="relative h-75 sm:h-100 md:h-125 rounded-lg overflow-hidden mb-8"
          >
            <Image
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              ...
              <motion.div key={product.title} variants={fadeIn}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base"
            >
              With over 35 years of experience, we have established ourselves as
              a trusted global partner for automotive manufacturers worldwide.
            </motion.p>
          </motion.div>
